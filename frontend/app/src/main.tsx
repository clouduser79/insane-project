...
function SparkleBackground({ count = 50, startTime }: { count?: number, startTime: number | null }) {
          ...
          <div className="file-upload-container">
            ...
            {showImageWarning && (
              <div style={{ color: '#ff5555', fontSize: '1em', textAlign: 'center' }}>
                Please upload at least one image of yourself!
              </div>
            )}
          </div>
          ...
          <>
            ...
            <div className="progress-bar">
              <div
                ...
                style={{
                  width: `${((currentIndex % allImages.length) / (allImages.length - 1)) * 100}%`,
                }}
              />
            </div>
            <div
